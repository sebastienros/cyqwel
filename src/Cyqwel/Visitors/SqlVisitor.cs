...
public abstract partial class SqlVisitor
{
    public virtual void Visit(SqlNode node)
    {
        ...
        switch (node)
        {
            ...
            case SqlBatch value: VisitBatch(value); break;
            case DeclareStatement value: VisitDeclare(value); break;
            case TableVariableDeclarationStatement value: VisitTableVariableDeclaration(value); break;
            case SetVariableStatement value: VisitSetVariable(value); break;
            case PrintStatement value: VisitPrint(value); break;
            case ExecuteSqlStatement value: VisitExecuteSql(value); break;
            case TransactionStatement value: VisitTransaction(value); break;
            ...
            case TSqlOutputClause value: VisitTSqlOutput(value); break;
            case MergeActionExpression value: VisitMergeActionExpression(value); break;
            case CreateInlineFunctionStatement value: VisitCreateInlineFunction(value); break;
            case CreateSchemaStatement value: VisitCreateSchema(value); break;
            case ComputedColumnDefinition value: VisitComputedColumnDefinition(value); break;
            case DefaultConstraint value: VisitDefaultConstraint(value); break;
            case AddTableElementAction value: VisitAddTableElement(value); break;
            ...
            case ConvertExpression value: VisitConvert(value); break;
            case JsonArrayAggregateExpression value: VisitJsonArrayAggregate(value); break;
            case QuantifiedComparisonExpression value: VisitQuantifiedComparison(value); break;
            ...
            case TSqlTableHint value: VisitTSqlTableHint(value); break;
            case TSqlIndexReference value: VisitTSqlIndexReference(value); break;
            case TSqlTableSample value: VisitTSqlTableSample(value); break;
            case DerivedTable value: VisitDerivedTable(value); break;
            case TableFunction value: VisitTableFunction(value); break;
            case ParenthesizedTable value: VisitParenthesizedTable(value); break;
            case DerivedMutationTable value: VisitDerivedMutationTable(value); break;
            case OpenJsonTable value: VisitOpenJsonTable(value); break;
            case OpenJsonColumn value: VisitOpenJsonColumn(value); break;
            case PivotTable value: VisitPivotTable(value); break;
            case UnpivotTable value: VisitUnpivotTable(value); break;
            case TSqlResultFormat value: VisitTSqlResultFormat(value); break;
            case TSqlQueryOption value: VisitTSqlQueryOption(value); break;
    ...
    protected virtual void VisitConvert(ConvertExpression node) => DefaultVisit(node);
    protected virtual void VisitJsonArrayAggregate(JsonArrayAggregateExpression node) => DefaultVisit(node);
    protected virtual void VisitQuantifiedComparison(QuantifiedComparisonExpression node) => DefaultVisit(node);
    ...
    protected virtual void VisitTSqlTableHint(TSqlTableHint node) => DefaultVisit(node);
    protected virtual void VisitTSqlIndexReference(TSqlIndexReference node) => DefaultVisit(node);
    protected virtual void VisitTSqlTableSample(TSqlTableSample node) => DefaultVisit(node);
    protected virtual void VisitDerivedTable(DerivedTable node) => DefaultVisit(node);
    protected virtual void VisitTableFunction(TableFunction node) => DefaultVisit(node);
    protected virtual void VisitParenthesizedTable(ParenthesizedTable node) => DefaultVisit(node);
    protected virtual void VisitDerivedMutationTable(DerivedMutationTable node) => DefaultVisit(node);
    protected virtual void VisitOpenJsonTable(OpenJsonTable node) => DefaultVisit(node);
    protected virtual void VisitOpenJsonColumn(OpenJsonColumn node) => DefaultVisit(node);
    protected virtual void VisitPivotTable(PivotTable node) => DefaultVisit(node);
    protected virtual void VisitUnpivotTable(UnpivotTable node) => DefaultVisit(node);
    protected virtual void VisitTSqlResultFormat(TSqlResultFormat node) => DefaultVisit(node);
    protected virtual void VisitTSqlQueryOption(TSqlQueryOption node) => DefaultVisit(node);
